...
namespace Google.Protobuf.WellKnownTypes
{
	...
	public static class TypeReflection
	{
		...
		// (get) Token: 0x06000347 RID: 839 RVA: 0x0000E201 File Offset: 0x0000C401
		...
		private static FileDescriptor descriptor = FileDescriptor.FromGeneratedCode(Convert.FromBase64String(string.Concat(new string[]
		{
			...
			"IjsKBk9wdGlvbhIMCgRuYW1lGAEgASgJEiMKBXZhbHVlGAIgASgLMhQuZ29v", "Z2xlLnByb3RvYnVmLkFueSouCgZTeW50YXgSEQoNU1lOVEFYX1BST1RPMhAA", "EhEKDVNZTlRBWF9QUk9UTzMQAUJ9ChNjb20uZ29vZ2xlLnByb3RvYnVmQglU", "eXBlUHJvdG9QAVovZ29vZ2xlLmdvbGFuZy5vcmcvZ2VucHJvdG8vcHJvdG9i", "dWYvcHR5cGU7cHR5cGX4AQGiAgNHUEKqAh5Hb29nbGUuUHJvdG9idWYuV2Vs", "bEtub3duVHlwZXNiBnByb3RvMw=="
		})), new FileDescriptor[]
		{
			AnyReflection.Descriptor,
			SourceContextReflection.Descriptor
		}, new GeneratedClrTypeInfo(new Type[] { typeof(Syntax) }, null, new GeneratedClrTypeInfo[]
		{
			new GeneratedClrTypeInfo(typeof(Type), Type.Parser, new string[] { "Name", "Fields", "Oneofs", "Options", "SourceContext", "Syntax" }, null, null, null, null),
			...
			new GeneratedClrTypeInfo(typeof(Enum), Enum.Parser, new string[] { "Name", "Enumvalue", "Options", "SourceContext", "Syntax" }, null, null, null, null),
			new GeneratedClrTypeInfo(typeof(EnumValue), EnumValue.Parser, new string[] { "Name", "Number", "Options" }, null, null, null, null),
			new GeneratedClrTypeInfo(typeof(Option), Option.Parser, new string[] { "Name", "Value" }, null, null, null, null)
		}));
	}
}
