...
namespace System
{
	...
	internal static class AppContextDefaultValues
	{
		...
		public static void PopulateDefaultValues()
		{
			...
			string text2;
			int num;
			global::System.AppContextDefaultValues.ParseTargetFrameworkName(out text, out text2, out num);
			global::System.AppContextDefaultValues.PopulateDefaultValuesPartial(text, text2, num);
		}
		...
		private static void ParseTargetFrameworkName(out string identifier, out string profile, out int version)
		{
			...
			if (!global::System.AppContextDefaultValues.TryParseFrameworkName(targetFrameworkName, out identifier, out version, out profile))
			{
