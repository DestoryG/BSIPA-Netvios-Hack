...
namespace System.Text.RegularExpressions
{
	...
	{
		// Token: 0x06003E37 RID: 15927 RVA: 0x001008C4 File Offset: 0x000FEAC4
		...
		// Token: 0x06003E38 RID: 15928 RVA: 0x00100AEC File Offset: 0x000FECEC
		...
		// Token: 0x06003E39 RID: 15929 RVA: 0x00100B00 File Offset: 0x000FED00
		...
		// Token: 0x06003E3A RID: 15930 RVA: 0x00100B14 File Offset: 0x000FED14
		...
		// Token: 0x06003E3B RID: 15931 RVA: 0x00100B54 File Offset: 0x000FED54
		...
		// Token: 0x06003E3C RID: 15932 RVA: 0x00100C50 File Offset: 0x000FEE50
		...
		// Token: 0x06003E3D RID: 15933 RVA: 0x00100CDA File Offset: 0x000FEEDA
		internal int AddTrack()
		{
			return this.AddTrack(128);
		}

		// Token: 0x06003E3E RID: 15934 RVA: 0x00100CE7 File Offset: 0x000FEEE7
		internal int AddTrack(int flags)
		{
			return this.AddBacktrackNote(flags, this.DefineLabel(), this._codepos);
		}

		// Token: 0x06003E3F RID: 15935 RVA: 0x00100CFC File Offset: 0x000FEEFC
		...
		// Token: 0x06003E40 RID: 15936 RVA: 0x00100D2D File Offset: 0x000FEF2D
		internal int AddUniqueTrack(int i)
		{
			return this.AddUniqueTrack(i, 128);
		}

		// Token: 0x06003E41 RID: 15937 RVA: 0x00100D3B File Offset: 0x000FEF3B
		...
		// Token: 0x06003E42 RID: 15938 RVA: 0x00100D5F File Offset: 0x000FEF5F
		internal Label DefineLabel()
		{
			return this._ilg.DefineLabel();
		}

		// Token: 0x06003E43 RID: 15939 RVA: 0x00100D6C File Offset: 0x000FEF6C
		internal void MarkLabel(Label l)
		{
			this._ilg.MarkLabel(l);
		}

		// Token: 0x06003E44 RID: 15940 RVA: 0x00100D7A File Offset: 0x000FEF7A
		internal int Operand(int i)
		{
			return this._codes[this._codepos + i + 1];
		}

		// Token: 0x06003E45 RID: 15941 RVA: 0x00100D8D File Offset: 0x000FEF8D
		internal bool IsRtl()
		{
			return (this._regexopcode & 64) != 0;
		}

		// Token: 0x06003E46 RID: 15942 RVA: 0x00100D9B File Offset: 0x000FEF9B
		internal bool IsCi()
		{
			return (this._regexopcode & 512) != 0;
		}

		// Token: 0x06003E47 RID: 15943 RVA: 0x00100DAC File Offset: 0x000FEFAC
		internal int Code()
		{
			return this._regexopcode & 63;
		}

		// Token: 0x06003E48 RID: 15944 RVA: 0x00100DB7 File Offset: 0x000FEFB7
		internal void Ldstr(string str)
		{
			this._ilg.Emit(OpCodes.Ldstr, str);
		}

		// Token: 0x06003E49 RID: 15945 RVA: 0x00100DCA File Offset: 0x000FEFCA
		...
		// Token: 0x06003E4A RID: 15946 RVA: 0x00100DFA File Offset: 0x000FEFFA
		...
		// Token: 0x06003E4B RID: 15947 RVA: 0x00100E38 File Offset: 0x000FF038
		internal void Dup()
		{
			this._ilg.Emit(OpCodes.Dup);
		}

		// Token: 0x06003E4C RID: 15948 RVA: 0x00100E4A File Offset: 0x000FF04A
		internal void Ret()
		{
			this._ilg.Emit(OpCodes.Ret);
		}

		// Token: 0x06003E4D RID: 15949 RVA: 0x00100E5C File Offset: 0x000FF05C
		private void Rem()
		{
			this._ilg.Emit(OpCodes.Rem);
		}

		// Token: 0x06003E4E RID: 15950 RVA: 0x00100E6E File Offset: 0x000FF06E
		private void Ceq()
		{
			this._ilg.Emit(OpCodes.Ceq);
		}

		// Token: 0x06003E4F RID: 15951 RVA: 0x00100E80 File Offset: 0x000FF080
		internal void Pop()
		{
			this._ilg.Emit(OpCodes.Pop);
		}

		// Token: 0x06003E50 RID: 15952 RVA: 0x00100E92 File Offset: 0x000FF092
		internal void Add()
		{
			this._ilg.Emit(OpCodes.Add);
		}

		// Token: 0x06003E51 RID: 15953 RVA: 0x00100EA4 File Offset: 0x000FF0A4
		...
		// Token: 0x06003E52 RID: 15954 RVA: 0x00100ECA File Offset: 0x000FF0CA
		internal void Sub()
		{
			this._ilg.Emit(OpCodes.Sub);
		}

		// Token: 0x06003E53 RID: 15955 RVA: 0x00100EDC File Offset: 0x000FF0DC
		...
		// Token: 0x06003E54 RID: 15956 RVA: 0x00100F02 File Offset: 0x000FF102
		internal void Ldloc(LocalBuilder lt)
		{
			this._ilg.Emit(OpCodes.Ldloc_S, lt);
		}

		// Token: 0x06003E55 RID: 15957 RVA: 0x00100F15 File Offset: 0x000FF115
		internal void Stloc(LocalBuilder lt)
		{
			this._ilg.Emit(OpCodes.Stloc_S, lt);
		}

		// Token: 0x06003E56 RID: 15958 RVA: 0x00100F28 File Offset: 0x000FF128
		internal void Ldthis()
		{
			this._ilg.Emit(OpCodes.Ldarg_0);
		}

		// Token: 0x06003E57 RID: 15959 RVA: 0x00100F3A File Offset: 0x000FF13A
		...
		// Token: 0x06003E58 RID: 15960 RVA: 0x00100F53 File Offset: 0x000FF153
		...
		// Token: 0x06003E59 RID: 15961 RVA: 0x00100F63 File Offset: 0x000FF163
		...
		// Token: 0x06003E5A RID: 15962 RVA: 0x00100F79 File Offset: 0x000FF179
		internal void Stfld(FieldInfo ft)
		{
			this._ilg.Emit(OpCodes.Stfld, ft);
		}

		// Token: 0x06003E5B RID: 15963 RVA: 0x00100F8C File Offset: 0x000FF18C
		internal void Callvirt(MethodInfo mt)
		{
			this._ilg.Emit(OpCodes.Callvirt, mt);
		}

		// Token: 0x06003E5C RID: 15964 RVA: 0x00100F9F File Offset: 0x000FF19F
		internal void Call(MethodInfo mt)
		{
			this._ilg.Emit(OpCodes.Call, mt);
		}

		// Token: 0x06003E5D RID: 15965 RVA: 0x00100FB2 File Offset: 0x000FF1B2
		internal void Newobj(ConstructorInfo ct)
		{
			this._ilg.Emit(OpCodes.Newobj, ct);
		}

		// Token: 0x06003E5E RID: 15966 RVA: 0x00100FC5 File Offset: 0x000FF1C5
		internal void BrfalseFar(Label l)
		{
			this._ilg.Emit(OpCodes.Brfalse, l);
		}

		// Token: 0x06003E5F RID: 15967 RVA: 0x00100FD8 File Offset: 0x000FF1D8
		internal void BrtrueFar(Label l)
		{
			this._ilg.Emit(OpCodes.Brtrue, l);
		}

		// Token: 0x06003E60 RID: 15968 RVA: 0x00100FEB File Offset: 0x000FF1EB
		internal void BrFar(Label l)
		{
			this._ilg.Emit(OpCodes.Br, l);
		}

		// Token: 0x06003E61 RID: 15969 RVA: 0x00100FFE File Offset: 0x000FF1FE
		internal void BleFar(Label l)
		{
			this._ilg.Emit(OpCodes.Ble, l);
		}

		// Token: 0x06003E62 RID: 15970 RVA: 0x00101011 File Offset: 0x000FF211
		internal void BltFar(Label l)
		{
			this._ilg.Emit(OpCodes.Blt, l);
		}

		// Token: 0x06003E63 RID: 15971 RVA: 0x00101024 File Offset: 0x000FF224
		internal void BgeFar(Label l)
		{
			this._ilg.Emit(OpCodes.Bge, l);
		}

		// Token: 0x06003E64 RID: 15972 RVA: 0x00101037 File Offset: 0x000FF237
		internal void BgtFar(Label l)
		{
			this._ilg.Emit(OpCodes.Bgt, l);
		}

		// Token: 0x06003E65 RID: 15973 RVA: 0x0010104A File Offset: 0x000FF24A
		internal void BneFar(Label l)
		{
			this._ilg.Emit(OpCodes.Bne_Un, l);
		}

		// Token: 0x06003E66 RID: 15974 RVA: 0x0010105D File Offset: 0x000FF25D
		internal void BeqFar(Label l)
		{
			this._ilg.Emit(OpCodes.Beq, l);
		}

		// Token: 0x06003E67 RID: 15975 RVA: 0x00101070 File Offset: 0x000FF270
		internal void Brfalse(Label l)
		{
			this._ilg.Emit(OpCodes.Brfalse_S, l);
		}

		// Token: 0x06003E68 RID: 15976 RVA: 0x00101083 File Offset: 0x000FF283
		internal void Br(Label l)
		{
			this._ilg.Emit(OpCodes.Br_S, l);
		}

		// Token: 0x06003E69 RID: 15977 RVA: 0x00101096 File Offset: 0x000FF296
		internal void Ble(Label l)
		{
			this._ilg.Emit(OpCodes.Ble_S, l);
		}

		// Token: 0x06003E6A RID: 15978 RVA: 0x001010A9 File Offset: 0x000FF2A9
		internal void Blt(Label l)
		{
			this._ilg.Emit(OpCodes.Blt_S, l);
		}

		// Token: 0x06003E6B RID: 15979 RVA: 0x001010BC File Offset: 0x000FF2BC
		internal void Bge(Label l)
		{
			this._ilg.Emit(OpCodes.Bge_S, l);
		}

		// Token: 0x06003E6C RID: 15980 RVA: 0x001010CF File Offset: 0x000FF2CF
		internal void Bgt(Label l)
		{
			this._ilg.Emit(OpCodes.Bgt_S, l);
		}

		// Token: 0x06003E6D RID: 15981 RVA: 0x001010E2 File Offset: 0x000FF2E2
		internal void Bgtun(Label l)
		{
			this._ilg.Emit(OpCodes.Bgt_Un_S, l);
		}

		// Token: 0x06003E6E RID: 15982 RVA: 0x001010F5 File Offset: 0x000FF2F5
		internal void Bne(Label l)
		{
			this._ilg.Emit(OpCodes.Bne_Un_S, l);
		}

		// Token: 0x06003E6F RID: 15983 RVA: 0x00101108 File Offset: 0x000FF308
		internal void Beq(Label l)
		{
			this._ilg.Emit(OpCodes.Beq_S, l);
		}

		// Token: 0x06003E70 RID: 15984 RVA: 0x0010111B File Offset: 0x000FF31B
		internal void Ldlen()
		{
			this._ilg.Emit(OpCodes.Ldlen);
		}

		// Token: 0x06003E71 RID: 15985 RVA: 0x0010112D File Offset: 0x000FF32D
		...
		// Token: 0x06003E72 RID: 15986 RVA: 0x00101154 File Offset: 0x000FF354
		...
		// Token: 0x06003E73 RID: 15987 RVA: 0x001011A3 File Offset: 0x000FF3A3
		...
		// Token: 0x06003E74 RID: 15988 RVA: 0x001011D8 File Offset: 0x000FF3D8
		...
		// Token: 0x06003E75 RID: 15989 RVA: 0x00101227 File Offset: 0x000FF427
		internal void Track()
		{
			this.ReadyPushTrack();
		...
		// Token: 0x06003E76 RID: 15990 RVA: 0x00101241 File Offset: 0x000FF441
		...
		// Token: 0x06003E77 RID: 15991 RVA: 0x0010125B File Offset: 0x000FF45B
		...
		// Token: 0x06003E78 RID: 15992 RVA: 0x00101270 File Offset: 0x000FF470
		...
		// Token: 0x06003E79 RID: 15993 RVA: 0x0010128B File Offset: 0x000FF48B
		...
		// Token: 0x06003E7A RID: 15994 RVA: 0x001012AC File Offset: 0x000FF4AC
		...
		// Token: 0x06003E7B RID: 15995 RVA: 0x0010132C File Offset: 0x000FF52C
		...
		// Token: 0x06003E7C RID: 15996 RVA: 0x001013BB File Offset: 0x000FF5BB
		...
		// Token: 0x06003E7D RID: 15997 RVA: 0x001013F9 File Offset: 0x000FF5F9
		...
		// Token: 0x06003E7E RID: 15998 RVA: 0x00101418 File Offset: 0x000FF618
		...
		// Token: 0x06003E7F RID: 15999 RVA: 0x0010146C File Offset: 0x000FF66C
		...
		// Token: 0x06003E80 RID: 16000 RVA: 0x001014EB File Offset: 0x000FF6EB
		...
		// Token: 0x06003E81 RID: 16001 RVA: 0x0010152C File Offset: 0x000FF72C
		...
		// Token: 0x06003E82 RID: 16002 RVA: 0x001015BB File Offset: 0x000FF7BB
		internal void PopDiscardStack()
		{
			this.PopDiscardStack(1);
		}

		// Token: 0x06003E83 RID: 16003 RVA: 0x001015C4 File Offset: 0x000FF7C4
		...
		// Token: 0x06003E84 RID: 16004 RVA: 0x00101614 File Offset: 0x000FF814
		internal void DoReplace()
		{
			this._ilg.Emit(OpCodes.Stelem_I4);
		}

		// Token: 0x06003E85 RID: 16005 RVA: 0x00101626 File Offset: 0x000FF826
		internal void DoPush()
		{
			this._ilg.Emit(OpCodes.Stelem_I4);
		}

		// Token: 0x06003E86 RID: 16006 RVA: 0x00101638 File Offset: 0x000FF838
		internal void Back()
		{
			this._ilg.Emit(OpCodes.Br, this._backtrack);
		}

		// Token: 0x06003E87 RID: 16007 RVA: 0x00101650 File Offset: 0x000FF850
		...
		// Token: 0x06003E88 RID: 16008 RVA: 0x001016FC File Offset: 0x000FF8FC
		internal int NextCodepos()
		{
			return this._codepos + RegexCode.OpcodeSize(this._codes[this._codepos]);
		}

		// Token: 0x06003E89 RID: 16009 RVA: 0x00101717 File Offset: 0x000FF917
		internal Label AdvanceLabel()
		{
			return this._labels[this.NextCodepos()];
		}

		// Token: 0x06003E8A RID: 16010 RVA: 0x0010172A File Offset: 0x000FF92A
		internal void Advance()
		{
			this._ilg.Emit(OpCodes.Br, this.AdvanceLabel());
		}

		// Token: 0x06003E8B RID: 16011 RVA: 0x00101742 File Offset: 0x000FF942
		...
		// Token: 0x06003E8C RID: 16012 RVA: 0x00101778 File Offset: 0x000FF978
		...
		// Token: 0x06003E8D RID: 16013 RVA: 0x001018FC File Offset: 0x000FFAFC
		...
		// Token: 0x06003E8E RID: 16014 RVA: 0x001019DC File Offset: 0x000FFBDC
		...
		// Token: 0x06003E8F RID: 16015 RVA: 0x00101A50 File Offset: 0x000FFC50
		...
		// Token: 0x06003E90 RID: 16016 RVA: 0x0010258F File Offset: 0x0010078F
		...
		// Token: 0x06003E91 RID: 16017 RVA: 0x001025B4 File Offset: 0x001007B4
		internal LocalBuilder DeclareInt()
		{
			return this._ilg.DeclareLocal(typeof(int));
		}

		// Token: 0x06003E92 RID: 16018 RVA: 0x001025CB File Offset: 0x001007CB
		internal LocalBuilder DeclareIntArray()
		{
			return this._ilg.DeclareLocal(typeof(int[]));
		}

		// Token: 0x06003E93 RID: 16019 RVA: 0x001025E2 File Offset: 0x001007E2
		internal LocalBuilder DeclareString()
		{
			return this._ilg.DeclareLocal(typeof(string));
		}

		// Token: 0x06003E94 RID: 16020 RVA: 0x001025FC File Offset: 0x001007FC
		...
		// Token: 0x06003E95 RID: 16021 RVA: 0x001026E0 File Offset: 0x001008E0
		...
		// Token: 0x06003E96 RID: 16022 RVA: 0x00104200 File Offset: 0x00102400
		...
		{
			// Token: 0x0600462C RID: 17964 RVA: 0x00125004 File Offset: 0x00123204
