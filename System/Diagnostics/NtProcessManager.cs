...
namespace System.Diagnostics
{
	...
	{
		// Token: 0x06003040 RID: 12352 RVA: 0x000DA1EC File Offset: 0x000D83EC
		...
		// (get) Token: 0x06003041 RID: 12353 RVA: 0x000DA3B2 File Offset: 0x000D85B2
		...
		// Token: 0x06003042 RID: 12354 RVA: 0x000DA3C0 File Offset: 0x000D85C0
		...
		// Token: 0x06003043 RID: 12355 RVA: 0x000DA3F8 File Offset: 0x000D85F8
		...
		// Token: 0x06003044 RID: 12356 RVA: 0x000DA44E File Offset: 0x000D864E
		public static ModuleInfo[] GetModuleInfos(int processId)
		{
			return NtProcessManager.GetModuleInfos(processId, false);
		}

		// Token: 0x06003045 RID: 12357 RVA: 0x000DA458 File Offset: 0x000D8658
		...
		// Token: 0x06003046 RID: 12358 RVA: 0x000DA478 File Offset: 0x000D8678
		...
		// Token: 0x06003047 RID: 12359 RVA: 0x000DA804 File Offset: 0x000D8A04
		...
		// Token: 0x06003048 RID: 12360 RVA: 0x000DA84C File Offset: 0x000D8A4C
		...
		// Token: 0x06003049 RID: 12361 RVA: 0x000DA8A8 File Offset: 0x000D8AA8
		...
		// Token: 0x0600304A RID: 12362 RVA: 0x000DA928 File Offset: 0x000D8B28
				...
				for (int i = 0; i < perf_DATA_BLOCK.NumObjectTypes; i++)
				{
					...
					for (int k = 0; k < perf_OBJECT_TYPE.NumInstances; k++)
					{
						...
						if (!text.Equals("_Total"))
						{
							...
							Microsoft.Win32.NativeMethods.PERF_COUNTER_BLOCK.ValidateBeforeRead(intPtr, data.Length, intPtr6);
							Marshal.PtrToStructure(intPtr6, perf_COUNTER_BLOCK);
							perf_COUNTER_BLOCK.Validate(data.Length - (int)((long)intPtr6 - (long)intPtr));
							if (perf_OBJECT_TYPE.ObjectNameTitleIndex == processIndex)
							{
		...
		// Token: 0x0600304B RID: 12363 RVA: 0x000DADB4 File Offset: 0x000D8FB4
		...
		// Token: 0x0600304C RID: 12364 RVA: 0x000DAE84 File Offset: 0x000D9084
		...
		// Token: 0x0600304D RID: 12365 RVA: 0x000DAF0C File Offset: 0x000D910C
		...
		// Token: 0x0600304E RID: 12366 RVA: 0x000DB010 File Offset: 0x000D9210
		...
		// Token: 0x0600304F RID: 12367 RVA: 0x000DB037 File Offset: 0x000D9237
