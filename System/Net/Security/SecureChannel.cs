...
namespace System.Net.Security
{
	...
	{
		// Token: 0x06001E58 RID: 7768 RVA: 0x0008DEFC File Offset: 0x0008C0FC
		...
		// Token: 0x06001E59 RID: 7769 RVA: 0x0008E050 File Offset: 0x0008C250
		...
		// (get) Token: 0x06001E5A RID: 7770 RVA: 0x0008E0C4 File Offset: 0x0008C2C4
		...
		// (get) Token: 0x06001E5B RID: 7771 RVA: 0x0008E0CC File Offset: 0x0008C2CC
		...
		// (get) Token: 0x06001E5C RID: 7772 RVA: 0x0008E0D4 File Offset: 0x0008C2D4
		...
		// Token: 0x06001E5D RID: 7773 RVA: 0x0008E0DC File Offset: 0x0008C2DC
		internal X509Certificate2 GetRemoteCertificate(out X509Certificate2Collection remoteCertificateStore)
		{
			...
			if (Logging.On)
			{
				Logging.PrintInfo(Logging.Web, global::System.SR.GetString("net_log_remote_certificate", new object[] { (x509Certificate == null) ? "null" : x509Certificate.ToString(true) }));
			}
			return x509Certificate;
		}

		// Token: 0x06001E5E RID: 7774 RVA: 0x0008E184 File Offset: 0x0008C384
		...
		// (get) Token: 0x06001E5F RID: 7775 RVA: 0x0008E1AE File Offset: 0x0008C3AE
		...
		// (get) Token: 0x06001E60 RID: 7776 RVA: 0x0008E1B6 File Offset: 0x0008C3B6
		...
		// (get) Token: 0x06001E61 RID: 7777 RVA: 0x0008E1BE File Offset: 0x0008C3BE
		...
		// (get) Token: 0x06001E62 RID: 7778 RVA: 0x0008E1C6 File Offset: 0x0008C3C6
		...
		// (get) Token: 0x06001E63 RID: 7779 RVA: 0x0008E1CE File Offset: 0x0008C3CE
		...
		// (get) Token: 0x06001E64 RID: 7780 RVA: 0x0008E1D6 File Offset: 0x0008C3D6
		...
		// (get) Token: 0x06001E65 RID: 7781 RVA: 0x0008E1F0 File Offset: 0x0008C3F0
		...
		// (get) Token: 0x06001E66 RID: 7782 RVA: 0x0008E1F8 File Offset: 0x0008C3F8
		...
		// Token: 0x06001E67 RID: 7783 RVA: 0x0008E200 File Offset: 0x0008C400
		internal void SetRefreshCredentialNeeded()
		{
			this.m_RefreshCredentialNeeded = true;
		}

		// Token: 0x06001E68 RID: 7784 RVA: 0x0008E209 File Offset: 0x0008C409
		internal void Close()
		{
			if (this.m_SecurityContext != null)
			{
		...
		// Token: 0x06001E69 RID: 7785 RVA: 0x0008E234 File Offset: 0x0008C434
		private X509Certificate2 EnsurePrivateKey(X509Certificate certificate)
		{
			...
			if (Logging.On)
			{
				Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_locating_private_key_for_certificate", new object[] { certificate.ToString(true) }));
			}
			try
			{
				...
				if (x509Certificate != null)
				{
					if (x509Certificate.HasPrivateKey)
					{
						if (Logging.On)
						{
							Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_cert_is_of_type_2"));
						}
						return x509Certificate;
					}
				...
				if (x509Store != null)
				{
					...
					if (x509Certificate2Collection.Count > 0 && x509Certificate2Collection[0].HasPrivateKey)
					{
						if (Logging.On)
						{
							Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_found_cert_in_store", new object[] { this.m_ServerMode ? "LocalMachine" : "CurrentUser" }));
						}
				...
				if (x509Store != null)
				{
					...
					if (x509Certificate2Collection.Count > 0 && x509Certificate2Collection[0].HasPrivateKey)
					{
						if (Logging.On)
						{
							Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_found_cert_in_store", new object[] { this.m_ServerMode ? "CurrentUser" : "LocalMachine" }));
						}
						return x509Certificate2Collection[0];
					}
				}
			...
			if (Logging.On)
			{
				Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_did_not_find_cert_in_store"));
			}
			return null;
		}

		// Token: 0x06001E6A RID: 7786 RVA: 0x0008E454 File Offset: 0x0008C654
				...
				lock (obj)
				{
					...
					if (x509Store == null)
					{
						...
						catch (Exception ex)
						{
							...
							if (Logging.On)
							{
								Logging.PrintError(Logging.Web, global::System.SR.GetString("net_log_open_store_failed", new object[] { storeLocation, ex }));
							}
							throw;
						}
					}
		...
		// Token: 0x06001E6B RID: 7787 RVA: 0x0008E584 File Offset: 0x0008C784
		...
		// Token: 0x06001E6C RID: 7788 RVA: 0x0008E5F0 File Offset: 0x0008C7F0
		...
		// Token: 0x06001E6D RID: 7789 RVA: 0x0008E700 File Offset: 0x0008C900
		...
		private bool AcquireClientCredentials(ref byte[] thumbPrint)
		{
			...
			if (this.m_CertSelectionDelegate != null)
			{
				...
				if (x509Certificate != null)
				{
					...
					if (Logging.On)
					{
						Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_got_certificate_from_delegate"));
					}
				}
				else if (this.ClientCertificates.Count == 0)
				{
					if (Logging.On)
					{
						Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_no_delegate_and_have_no_client_cert"));
					}
					flag = true;
				}
				else if (Logging.On)
				{
					Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_no_delegate_but_have_client_cert"));
				}
			}
			else if (this.m_CredentialsHandle == null && this.m_ClientCertificates != null && this.m_ClientCertificates.Count > 0)
			{
				...
				if (Logging.On)
				{
					Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_attempting_restart_using_cert", new object[] { (x509Certificate == null) ? "null" : x509Certificate.ToString(true) }));
				}
			}
			else if (this.m_ClientCertificates != null && this.m_ClientCertificates.Count > 0)
			{
				...
				if (Logging.On)
				{
					...
					{
						Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_no_issuers_try_all_certs"));
					}
					else
					{
						Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_server_issuers_look_for_matching_certs", new object[] { array.Length }));
					}
				}
				int i = 0;
				while (i < this.m_ClientCertificates.Count)
				{
					...
					if (Logging.On)
					{
						Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_selected_cert", new object[] { this.m_ClientCertificates[i].ToString(true) }));
					}
			...
			if (Logging.On)
			{
				Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_n_certs_after_filtering", new object[] { arrayList.Count }));
				if (arrayList.Count != 0)
				{
					Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_finding_matching_certs"));
				}
			}
			...
			try
			{
				...
				if (safeFreeCredentials != null)
				{
					if (Logging.On)
					{
						Logging.PrintInfo(Logging.Web, global::System.SR.GetString("net_log_using_cached_credential"));
					}
		...
		// Token: 0x06001E6E RID: 7790 RVA: 0x0008EC74 File Offset: 0x0008CE74
		[StorePermission(SecurityAction.Assert, Unrestricted = true)]
		private bool AcquireServerCredentials(ref byte[] thumbPrint)
		{
			...
			if (x509Certificate == null)
			{
				throw new NotSupportedException(global::System.SR.GetString("net_ssl_io_no_server_cert"));
			}
		...
		// Token: 0x06001E6F RID: 7791 RVA: 0x0008ED74 File Offset: 0x0008CF74
		...
		// Token: 0x06001E70 RID: 7792 RVA: 0x0008EE38 File Offset: 0x0008D038
		[SecurityPermission(SecurityAction.Assert, Flags = SecurityPermissionFlag.ControlPrincipal)]
		...
		// Token: 0x06001E71 RID: 7793 RVA: 0x0008EEAC File Offset: 0x0008D0AC
		[SecurityPermission(SecurityAction.Assert, Flags = SecurityPermissionFlag.ControlPrincipal)]
		...
		// Token: 0x06001E72 RID: 7794 RVA: 0x0008EF20 File Offset: 0x0008D120
		...
		// Token: 0x06001E73 RID: 7795 RVA: 0x0008EF68 File Offset: 0x0008D168
		...
		// Token: 0x06001E74 RID: 7796 RVA: 0x0008F184 File Offset: 0x0008D384
		...
		// Token: 0x06001E75 RID: 7797 RVA: 0x0008F218 File Offset: 0x0008D418
		...
		// Token: 0x06001E76 RID: 7798 RVA: 0x0008F340 File Offset: 0x0008D540
		...
		// Token: 0x06001E77 RID: 7799 RVA: 0x0008F414 File Offset: 0x0008D614
		[StorePermission(SecurityAction.Assert, Unrestricted = true)]
		...
		// Token: 0x06001E78 RID: 7800 RVA: 0x0008F664 File Offset: 0x0008D864
		...
		// Token: 0x06001E79 RID: 7801 RVA: 0x0008F6C8 File Offset: 0x0008D8C8
		...
		// Token: 0x06001E7A RID: 7802 RVA: 0x0008F700 File Offset: 0x0008D900
		...
		// Token: 0x06001E7B RID: 7803 RVA: 0x0008F724 File Offset: 0x0008D924
		...
		// Token: 0x06001E7C RID: 7804 RVA: 0x0008F7C4 File Offset: 0x0008D9C4
		private void LogCertificateValidation(RemoteCertValidationCallback remoteCertValidationCallback, SslPolicyErrors sslPolicyErrors, bool success, X509Chain chain)
		{
			...
			{
				Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_remote_cert_has_errors"));
				if ((sslPolicyErrors & SslPolicyErrors.RemoteCertificateNotAvailable) != SslPolicyErrors.None)
				{
					Logging.PrintInfo(Logging.Web, this, "\t" + global::System.SR.GetString("net_log_remote_cert_not_available"));
				}
				if ((sslPolicyErrors & SslPolicyErrors.RemoteCertificateNameMismatch) != SslPolicyErrors.None)
				{
					Logging.PrintInfo(Logging.Web, this, "\t" + global::System.SR.GetString("net_log_remote_cert_name_mismatch"));
				}
			...
			if (!success)
			{
				if (remoteCertValidationCallback != null)
				{
					Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_remote_cert_user_declared_invalid"));
				}
				return;
			}
			if (remoteCertValidationCallback != null)
			{
				Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_remote_cert_user_declared_valid"));
				return;
			}
			Logging.PrintInfo(Logging.Web, this, global::System.SR.GetString("net_log_remote_cert_has_no_errors"));
		}
		...
		{
			// Token: 0x0600439A RID: 17306 RVA: 0x0011CEDC File Offset: 0x0011B0DC
