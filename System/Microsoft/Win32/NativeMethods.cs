...
namespace Microsoft.Win32
{
	...
	internal static class NativeMethods
	{
		...
		{
			throw new InvalidOperationException(SR.GetString("InvalidPerfData", new object[] { type.Name }));
		}
		...
		{
			// Token: 0x06003FDC RID: 16348 RVA: 0x0010C898 File Offset: 0x0010AA98
			public STARTUPINFO()
			{
				this.cb = Marshal.SizeOf(this);
			}

			// Token: 0x06003FDD RID: 16349 RVA: 0x0010C918 File Offset: 0x0010AB18
			public void Dispose()
			{
		...
		// (Invoke) Token: 0x06003FE2 RID: 16354
		public delegate IntPtr WndProc(IntPtr hWnd, int msg, IntPtr wParam, IntPtr lParam);

		// Token: 0x020006BB RID: 1723
		// (Invoke) Token: 0x06003FE6 RID: 16358
		...
		{
			// Token: 0x06003FEB RID: 16363 RVA: 0x0010CA55 File Offset: 0x0010AC55
			...
			// Token: 0x06003FEC RID: 16364 RVA: 0x0010CA64 File Offset: 0x0010AC64
		...
		{
			// Token: 0x06003FEF RID: 16367 RVA: 0x0010CAB0 File Offset: 0x0010ACB0
			public static void ValidateBeforeRead(IntPtr bufferStart, int bufferSize, IntPtr current)
			{
				NativeMethods.ValidateBeforeRead(bufferStart, bufferSize, current, NativeMethods.PERF_COUNTER_DEFINITION.SizeOf);
			}

			// Token: 0x06003FF0 RID: 16368 RVA: 0x0010CAC0 File Offset: 0x0010ACC0
			public void Validate(int bufferSize)
			{
		...
		{
			// Token: 0x06003FF3 RID: 16371 RVA: 0x0010CB32 File Offset: 0x0010AD32
			public static void ValidateBeforeRead(IntPtr bufferStart, int bufferSize, IntPtr current)
			{
				NativeMethods.ValidateBeforeRead(bufferStart, bufferSize, current, NativeMethods.PERF_DATA_BLOCK.SizeOf);
			}

			// Token: 0x06003FF4 RID: 16372 RVA: 0x0010CB44 File Offset: 0x0010AD44
			public void Validate(int bufferSize)
			{
		...
		{
			// Token: 0x06003FF7 RID: 16375 RVA: 0x0010CBB6 File Offset: 0x0010ADB6
			public static void ValidateBeforeRead(IntPtr bufferStart, int bufferSize, IntPtr current)
			{
				NativeMethods.ValidateBeforeRead(bufferStart, bufferSize, current, NativeMethods.PERF_INSTANCE_DEFINITION.SizeOf);
			}

			// Token: 0x06003FF8 RID: 16376 RVA: 0x0010CBC8 File Offset: 0x0010ADC8
			public void Validate(int bufferSize)
			{
		...
		{
			// Token: 0x06003FFB RID: 16379 RVA: 0x0010CC46 File Offset: 0x0010AE46
			public static void ValidateBeforeRead(IntPtr bufferStart, int bufferSize, IntPtr current)
			{
				NativeMethods.ValidateBeforeRead(bufferStart, bufferSize, current, NativeMethods.PERF_OBJECT_TYPE.SizeOf);
			}

			// Token: 0x06003FFC RID: 16380 RVA: 0x0010CC58 File Offset: 0x0010AE58
			public void Validate(int bufferSize)
			{
		...
		{
			// Token: 0x06004003 RID: 16387 RVA: 0x0010CD78 File Offset: 0x0010AF78
		...
		{
			// Token: 0x0600400A RID: 16394 RVA: 0x0010CE64 File Offset: 0x0010B064
		...
		{
			// Token: 0x0600400E RID: 16398 RVA: 0x0010CF43 File Offset: 0x0010B143
			public static int HIWORD(int n)
			{
				return (n >> 16) & 65535;
			}

			// Token: 0x0600400F RID: 16399 RVA: 0x0010CF4F File Offset: 0x0010B14F
