...
namespace System.Runtime.Serialization
{
	...
	{
		// Token: 0x06000F3A RID: 3898 RVA: 0x0003E226 File Offset: 0x0003C426
		internal static string GetString(string name, params object[] args)
		{
			return SR.GetString(CultureInfo.InvariantCulture, name, args);
		}

		// Token: 0x06000F3B RID: 3899 RVA: 0x0003E234 File Offset: 0x0003C434
		internal static string GetString(CultureInfo culture, string name, params object[] args)
		{
			return string.Format(culture, name, args);
		}

		// Token: 0x06000F3C RID: 3900 RVA: 0x0003E23E File Offset: 0x0003C43E
		internal static string GetString(string name)
		{
			return name;
		}

		// Token: 0x06000F3D RID: 3901 RVA: 0x0003E241 File Offset: 0x0003C441
		internal static string GetString(CultureInfo culture, string name)
		{
			return name;
		}

		// Token: 0x06000F3E RID: 3902 RVA: 0x0003E244 File Offset: 0x0003C444
		internal static string Format(string resourceFormats)
		{
			return resourceFormats;
		}

		// Token: 0x06000F3F RID: 3903 RVA: 0x0003E247 File Offset: 0x0003C447
