...
namespace System.IO
{
	...
	{
		// Token: 0x060018D7 RID: 6359 RVA: 0x000511A8 File Offset: 0x0004F3A8
		[SecurityCritical]
		internal unsafe static string Normalize(string path, uint maxPathLength, bool checkInvalidCharacters, bool expandShortPaths)
		{
			...
			try
			{
				...
				{
					text = LongPathHelper.TryExpandShortFileName(stringBuffer2, path);
				}
		...
		// Token: 0x060018D8 RID: 6360 RVA: 0x000513D8 File Offset: 0x0004F5D8
		[SecurityCritical]
		...
		// Token: 0x060018D9 RID: 6361 RVA: 0x00051454 File Offset: 0x0004F654
		[SecurityCritical]
		...
		// Token: 0x060018DA RID: 6362 RVA: 0x000514D4 File Offset: 0x0004F6D4
		[SecurityCritical]
		...
		// Token: 0x060018DB RID: 6363 RVA: 0x00051548 File Offset: 0x0004F748
		[SecurityCritical]
		...
		// Token: 0x060018DC RID: 6364 RVA: 0x0005156C File Offset: 0x0004F76C
