...
namespace Microsoft.Win32
{
	...
	{
		// Token: 0x060000ED RID: 237 RVA: 0x000023C0 File Offset: 0x000005C0
		[SecurityCritical]
		internal static Variant ChangeType(Variant source, Type targetClass, short options, CultureInfo culture)
		{
			...
			OAVariantLib.ChangeTypeEx(ref variant, ref source, culture.LCID, targetClass.TypeHandle.Value, OAVariantLib.GetCVTypeFromClass(targetClass), options);
			return variant;
		}

		// Token: 0x060000EE RID: 238 RVA: 0x0000241C File Offset: 0x0000061C
